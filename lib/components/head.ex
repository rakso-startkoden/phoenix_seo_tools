defmodule ExWebTools.Components.Head do
  @moduledoc """
  ...
  that have been generated by the `ExWebTools.SEO` module.
  ...
  The `meta` assign is expected to come from the `ExWebTools.SEO.build_meta/2` function.
  """
  ...
  * `meta` - A map containing SEO metadata, typically coming from `ExWebTools.SEO.build_meta/2`
    * `:page_title` - The title of the page
    * `:metas` - A list of `ExWebTools.PageMeta` structs
    * `:schemas` - A list of JSON-LD structured data maps
    * `:links` - A list of `ExWebTools.PageLink` structs
